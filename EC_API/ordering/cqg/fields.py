...
from EC_API.ordering.enums import Side, SubScope, OrderType, Duration, ExecInstruction
from EC_API.ordering.cqg.enums import SubScopeCQG, OrderTypeCQG, DurationCQG, ExecInstructionCQG
