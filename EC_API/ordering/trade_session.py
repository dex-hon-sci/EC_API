...
class TradeSession(Protocol):
    ...
    # --- Getters ---
    def get_order_status(self, chain_order_id: str) -> OrderStatusType | None: ...
    def get_position_status(self, symbol_name: str) -> PositionStatusType | None: ...
    def get_account_summay(self) -> AccountSummaryType | None: ...

    # --- Requests ---
    async def resolve_symbol(self, symbol_name: str) -> list[ContractMetaDataType] | None: ...
    async def unsubscribe_symbol(self, symbol_name: str) -> list[ContractMetaDataType] | None: ...
