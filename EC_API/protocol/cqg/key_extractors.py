...
from EC_API._typing import RouterKey, Extractor_func, KeyHit
...
def extract_session_router_keys(msg: ServerMsg, msg_type: str) -> Sequence[RouterKey]:
    if msg_type == "pong":
        rid = "token"
        val = msg.pong.token
    else:
...
def extract_info_keys(msg: ServerMsg, msg_type: str) -> Sequence[RouterKey]:
    TARGET = {
...
def extract_rpc_reqid_router_keys(msg: ServerMsg, msg_type: str) -> Sequence[RouterKey]:
    TARGET = {
...
def extract_sub_router_keys(msg: ServerMsg, msg_type: str) -> Sequence[RouterKey]:
    TARGET = {
...
def extract_substream_router_keys(msg: ServerMsg, msg_type: str) -> Sequence[RouterKey]:
    TARGET = {"order_statuses", "position_statuses", "account_summary_statuses"}
    IDs = {
...
def extract_market_data_router_keys(msg: ServerMsg, msg_type: str):
    TARGET = {"real_time_market_data"}
