...
MAP_RESPONSES_TYPES_STR = {
    ...
    "market_data_subscriptions": ["market_data_subscription_statuses", "real_time_market_data"],
...
LOGON_RESULT_STATUS_ENUMS_BOOL = {
    ...
    "Reject": [
        LOR.ResultCode.RESULT_CODE_FAILURE,
...
LOGGEDOFF_REASON_ENUMS_BOOL = {
    "Accept": [
        LOff.LogoffReason.LOGOFF_REASON_BY_REQUEST,
...
RESTORE_STATUS_ENUMS_BOOL = {
    ...
    "Reject": [
        Restore.ResultCode.RESULT_CODE_FAILURE,
...
TIMESALES_REPORT_RESULT_ENUMS_BOOL = {
    "Accept": [TSR.ResultCode.RESULT_CODE_SUCCESS, TSR.ResultCode.RESULT_CODE_DROPPED],
    "Reject": [
        TSR.ResultCode.RESULT_CODE_DISCONNECTED,
...
VOLUMEPROFILE_REPORT_RESULT_ENUMS_BOOL = {
    "Accept": [
        VPR.ResultCode.RESULT_CODE_SUCCESS,
        VPR.ResultCode.RESULT_CODE_DROPPED,
    ],
    "Reject": [
        VPR.ResultCode.RESULT_CODE_DISCONNECTED,
...
MARKETDATA_SUB_STATUS_ENUMS_BOOL = {
    "Accept": [
        MDSS.StatusCode.STATUS_CODE_SUCCESS,
    ],
    "Reject": [
        MDSS.StatusCode.STATUS_CODE_DISCONNECTED,
...
TRADESUBSCRIPTIONS_STATUS_ENUMS_BOOL = {
    ...
    "Reject": [
        TSS.StatusCode.STATUS_CODE_DISCONNECTED,
...
NEWORDER_ORDERSTATUS_ENUMS_BOOL = {
    "Accept": [OS.Status.WORKING, OS.Status.FILLED, OS.Status.SUSPENDED],
    "Reject": [OS.Status.REJECTED, OS.Status.DISCONNECTED, OS.Status.EXPIRED],
    "Transit": [
...
MODIFYORDER_ORDERSTATUS_ENUMS_BOOL = {
    "Accept": [OS.Status.WORKING, OS.Status.IN_MODIFY, OS.Status.FILLED],
    "Reject": [OS.Status.REJECTED, OS.Status.DISCONNECTED, OS.Status.EXPIRED],
    "Transit": [
        OS.Status.IN_TRANSIT,
    ],
...
CANCELORDER_ORDERSTATUS_ENUMS_BOOL = {
    "Accept": [OS.Status.WORKING, OS.Status.IN_CANCEL, OS.Status.CANCELLED, OS.Status.FILLED],
    "Reject": [OS.Status.REJECTED, OS.Status.DISCONNECTED, OS.Status.EXPIRED],
    "Transit": [
        OS.Status.IN_TRANSIT,
    ],
...
ACTIVEATORDER_ORDERSTATUS_ENUMS_BOOL = {
    "Accept": [OS.Status.WORKING, OS.Status.ACTIVEAT, OS.Status.FILLED],
    "Reject": [
        OS.Status.REJECTED,
...
GOFLAT_ORDERSTATUS_ENUMS_BOOL = {
    ...
    "Reject": [GFS.StatusCode.STATUS_CODE_TIMED_OUT, GFS.StatusCode.STATUS_CODE_FAILED],
}

ORDER_REJECT_CODE_ENUMS_BOOL = {"Accept": [i for i in range(1001, 1257)] + [99]}
...
MAP_STATUS_ENUMS = {
    ...
    "order_statuses": {
        "new_order": NEWORDER_ORDERSTATUS_ENUMS_BOOL,
