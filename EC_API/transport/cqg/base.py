...
from EC_API.ext.WebAPI.websocket import WebSocketWantWriteError, WebSocketWantReadError
...
class TransportCQG:
    ...
    def start(self) -> None:
        self._send_thread = threading.Thread(
            target=self._send_loop, daemon=True, name="TransportCQG-send_loop"
        )
        self._recv_thread = threading.Thread(
            target=self._recv_loop, daemon=True, name="TransportCQG-recv_loop"
        )
