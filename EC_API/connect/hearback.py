...
def hearback(client,  
             client_msg: ClientMsg = None,
             hearback_time: float = 30) -> ServerMsg | None:
    # A decorator function in charge of hearing back a message 
...
def get_contract_metadata(client, client_msg: ClientMsg):
